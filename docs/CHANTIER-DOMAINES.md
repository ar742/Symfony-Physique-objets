...
Le [deuxième volet E1b](MAGNETOSTATIQUE-E1B.md) livre trois fiches : force de Lorentz et trajectoires, champ d’un fil par Ampère, puis champ axial d’une spire. Les repères sont CPGE P14 p. 379 et 383, puis théorie PC2 p. 266 et 269. Une seconde boucle conserve l’accès au premier parcours.

Le [troisième volet E1c](INDUCTION-E1C.md) livre le champ axial du solénoïde fini, l’induction dans une bobine fixe et la tige mobile sur des rails. Il utilise CPGE P14 p. 379, 380 et 383, et théorie PC2 p. 269. Une troisième boucle conserve les parcours E1a et E1b.

Le [quatrième volet E1d](MAXWELL-INDUCTANCE-E1D.md) livre le courant de déplacement et la conservation de charge dans un condensateur, l’auto-induction et l’énergie magnétique, puis le circuit RL. Il utilise CPGE P14 p. 379–380, P15 p. 391, et théorie PC2 p. 264–265 et 269. Une quatrième boucle conserve les trois précédentes. La fiche RL reste rattachée à l’électromagnétisme et prépare le futur domaine des circuits E2 ; elle ne couvre pas à elle seule ce lot.

Le [cinquième volet E1e](ONDES-ELECTROMAGNETIQUES-E1E.md) livre l’onde plane monochromatique dans le vide, la polarisation et l’analyseur linéaire, puis le flux d’énergie de Poynting. Les repères sont CPGE P10 p. 339 et P11 p. 352, 354–355, puis théorie PC2 p. 263–265 et 280. Une cinquième boucle conserve les quatre précédentes. La polarisation reste rattachée à l’électromagnétisme et prépare l’optique O1 sans en couvrir tout le chantier.

Les volets suivants prévus portent notamment sur les milieux, les interfaces et les couplages inductifs. Les conditions aux limites seront abordées avec leurs hypothèses propres. Chaque fiche suivra la même structure 6 × 6 et ses évaluations.
...
Voir [le journal des avancées](AVANCEES.md). M1 et M2 ont livré huit fiches de mécanique et deux boucles. F1 ajoute six fiches et deux boucles pour les fluides, l'élasticité, la corde et l'acoustique. Ces livraisons constituent des premiers parcours délimités ; elles ne transposent pas l'intégralité des chapitres sources. M2 se limite notamment à une introduction analytique sur un système à un degré de liberté. AP1 à AP8 achèvent un premier approfondissement des analyses à deux niveaux des 22 fiches, y compris la thermodynamique et la physique statistique. E1a ouvre le domaine Électromagnétisme avec le champ de Coulomb, le potentiel et l’énergie, puis Gauss sur une sphère chargée. E1b poursuit par Lorentz, Ampère et la spire, puis E1c par le solénoïde et deux modèles d’induction. E1d ajoute Maxwell dans le condensateur, l’énergie inductive et RL. E1e ajoute les ondes dans le vide, leur polarisation et leur énergie. Les milieux, interfaces, couplages et autres circuits restent à développer ; la relecture scientifique avec l’auteur reste ouverte. Les autres lots restent planifiés tant que le journal ne mentionne pas une livraison effective.
