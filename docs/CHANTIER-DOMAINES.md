...
Les volets suivants prévus portent notamment sur les ondes électromagnétiques, les milieux et les couplages inductifs. Les milieux et les conditions aux limites seront abordés avec leurs hypothèses propres. Chaque fiche suivra la même structure 6 × 6 et ses évaluations.
...
Voir [le journal des avancées](AVANCEES.md). M1 et M2 ont livré huit fiches de mécanique et deux boucles. F1 ajoute six fiches et deux boucles pour les fluides, l'élasticité, la corde et l'acoustique. Ces livraisons constituent des premiers parcours délimités ; elles ne transposent pas l'intégralité des chapitres sources. M2 se limite notamment à une introduction analytique sur un système à un degré de liberté. AP1 à AP8 achèvent un premier approfondissement des analyses à deux niveaux des 22 fiches, y compris la thermodynamique et la physique statistique. E1a ouvre le domaine Électromagnétisme avec le champ de Coulomb, le potentiel et l’énergie, puis Gauss sur une sphère chargée. E1b poursuit par Lorentz, Ampère et la spire, puis E1c par le solénoïde et deux modèles d’induction. E1d ajoute Maxwell dans le condensateur, l’énergie inductive et RL. Les ondes électromagnétiques, les milieux, les couplages et les autres circuits restent à développer ; la relecture scientifique avec l’auteur reste ouverte. Les autres lots restent planifiés tant que le journal ne mentionne pas une livraison effective.
