...
Les [lots AP1 à AP3 de perfectionnement](PRECISIONS-ANALYTIQUES.md) précisent neuf analyses : oscillateur, Bernoulli, Lagrange–Hamilton, travail-énergie, Poiseuille, corde, rotation axiale, roulement et référentiel tournant. Entrées, fonctions théoriques, relations et évaluations sont définies aux deux étages. Treize fiches conservent leur première rédaction analytique ; leur reprise et les nouvelles fiches suivront les mêmes exigences de sens.
