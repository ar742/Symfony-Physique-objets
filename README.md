...
Son [explorateur des lagrangiens et surfaces](docs/LAGRANGIEN-SURFACES.md) distingue le plan du vrai lagrangien d’un PL enregistré, la nappe de rendement suivant deux partages et la courbe des entrées couplées A2/A5. Les lois et commandes restantes sont figées ; les projections de marqueurs sont recalculées. Ces vues expliquent les résultats sans fabriquer un pic ni remplacer la preuve globale.
