...
- **Chaque fiche possède six systèmes globaux et six sous-niveaux par système** : 150 systèmes et **900 sous-niveaux rédigés pour les 25 fiches**. Un clic ouvre la sous-boucle, puis la description du point choisi ; survol, clavier et boutons d'information tactiles donnent accès aux explications.
...
- **Des entrées et évaluations explicites pour les 25 fiches** : 900 sous-niveaux précisent les entrées, 1 050 relations qualifient les liens et 525 évaluations détaillent objets, conditions, critères et constats. La nature physique ou théorique du sujet est explicite. Voir [les approfondissements AP1 à AP8](docs/PRECISIONS-ANALYTIQUES.md) et [le premier volet E1a](docs/ELECTROSTATIQUE-E1A.md).
...
- Une page **Domaines** : quatre domaines disponibles, huit autres planifiés avec repères dans les recueils ; 25 fiches et 52 équations MathML au total.
- Un journal de **dix-huit corrections ou clarifications** des passages utilisés des recueils.
...
La boucle, les quatre domaines et les vingt-cinq fiches sont présents dès le démarrage. Les tables d'archives sont initialement vides ; leur import est facultatif. Sur un PC où le projet modernisé fonctionne déjà, publier ce dépôt ne nécessite pas de réinstaller le site.
