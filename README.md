...
- **Neuf analyses approfondies** : oscillateur, Bernoulli, Lagrange–Hamilton, travail-énergie, Poiseuille, corde, rotation axiale, roulement et référentiel tournant. Leurs 324 sous-niveaux précisent les entrées, 378 relations qualifient les liens et 189 évaluations détaillent objets, conditions, critères et constats. La nature physique ou théorique du sujet est explicite. Voir [les lots AP1 à AP3](docs/PRECISIONS-ANALYTIQUES.md).
